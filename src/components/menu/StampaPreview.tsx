...
import { getBisettimanaRange } from '@/lib/bisettimane'
import { useFooterConfig } from '@/hooks/useFooterConfig'
import { formatPrezzo, SUPPL_PREFIX, wrapPiatti } from '@/lib/footer'
import type { FlagKey, MenuVoce, Servizio } from '@/types/menuVoce'
